...
{	
	...
	public class SMTPUtil
	{
		...
		public var SmtpfrmLbl : String="admin@adam-studio.com";
		...
		public function SMTPUtil():void {
			if(!myMailer) myMailer = new SMTPMailer (SmtpHost, SmtpPort);
		...
		public static function attachMail( to_mail:String, subject_mail:String, message_mail:String, pByteArray:ByteArray, pFileName:String ):void
		{
			// send HTML email with picture file attached
			//sendAttachedMail ( origFrom:String, pFrom:String, pDest:String, pSubject:String, pMess:String, pByteArray:ByteArray, pFileName:String )
			myMailer.sendAttachedMail(origEmail, fromEmail, to_mail, subject_mail, message_mail,pByteArray, pFileName )
		}
